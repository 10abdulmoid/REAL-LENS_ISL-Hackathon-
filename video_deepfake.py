...
# Device configuration for macOS GPU (MPS)
        ...
        while cap.isOpened():
            ...
            for (x, y, w, h) in faces:
                ...
                with torch.no_grad():
                    ...
                    outputs = outputs.cpu()  # Move to CPU for unsupported MPS ops
...
def main():
    model_path = 'vit_deepfake.pth'  # Replace with your model path
    video_path = 'VIDEO-2025-01-24-02-15-50.mp4'  # Replace with your video path
